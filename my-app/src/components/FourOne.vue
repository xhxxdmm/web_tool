...
<<<<<<< HEAD
        ...
        <div class="manage-header">
            ...
            <!-- <el-form inline = "true" :model="userForm">
                <el-form-item >
                    RecordId:<el-input placeholder="Please input:  RecordId" clearable v-model="userForm.record_id" style="width: 200px"></el-input>
                </el-form-item>
                <el-form-item >
                    Radio_productName:<el-input size="small" placeholder="Please input:  Radio_productName" clearable v-model="userForm.name" style="width: 200px"></el-input>
                </el-form-item>
                <el-form-item>
                    Radio_productRevision:<el-input size="small" placeholder="Please input:  Radio_productRevision" clearable v-model="userForm.revision" style="width: 200px"></el-input>
                </el-form-item>
                <el-form-item>
        ...
        <div class="common-tabel">
            <el-table stripe height="94%" :data="tableData" style="width: 100%">
                ...
                <el-table-column v-show="isOptionsVisible" prop="options" label="Options" width="200px" align="center" fixed="right">
                    <template slot-scope="scope">
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    channel_model: [{ required: false, message: "请输入Channel_Model" }],
                    lac_config_file: [{ required: false, message: "请输入LAC_Config_File" }],
